...
/*
 * Phase 15's second-sighting gate (filterConfirmedSightings) lived here
 * until Phase 16 Part A CONVERTED it into the confirmation-pair matcher:
 * the lastSeenAt-advanced judgement now lives in
 * opportunities/confirmation.ts, and alert dispatch fires from index.ts's
 * onConfirmed fan-out (records reaching 'confirmed') instead of per scan.
 */
